...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    // determineDx function is unneccesary. removed.
...
// Instead of accessing DOM multiple times in for function,
// required DOM elements passed into pizzas variable only at one
    var pizzas = document.querySelectorAll(".randomPizzaContainer");

    for (var i = 0; i < pizzas.length; i++) {
      // following two lines are completely unneccesary
      // var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);
      // var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';

      // Instead of document.querySelectorAll, pizzas variable used.
...
// Next line moved out of for loop. (unnecesary loop)
...
// Instead of accessing DOM multiple times in for function,
// required elements passed into docBodyScrollTop variable only once
